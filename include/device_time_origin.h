...
class DeviceTimeOriginEstimator
{
public:
  DeviceTimeOriginEstimator()
  {
  }
  static ros::Time estimateOriginByAverage(
  ...
  static ros::Time estimateOrigin(
      const boost::posix_time::ptime& time_response,
      const uint64_t& device_timestamp,
...
class DeviceTimeOriginJumpDetector
{
public:
  DeviceTimeOriginJumpDetector()
  {
  }
  static bool detectTimeJump(
