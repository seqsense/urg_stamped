...
#ifndef SCIP2_RESPONSE_RESET_H
#define SCIP2_RESPONSE_RESET_H
...
namespace scip2
{
class ResponseRS : public Response
{
public:
...
class ResponseRT : public Response
{
public:
  using Callback = boost::function<void(
      const boost::posix_time::ptime&,
